...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// btnBuild
			// 
			this->btnBuild->Location = System::Drawing::Point(279, 706);
			this->btnBuild->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnBuild->Name = L"btnBuild";
			this->btnBuild->Size = System::Drawing::Size(84, 29);
			...
			// tbYmax
			// 
			this->tbYmax->Location = System::Drawing::Point(1403, 66);
			this->tbYmax->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->tbYmax->Name = L"tbYmax";
			this->tbYmax->Size = System::Drawing::Size(49, 26);
			this->tbYmax->TabIndex = 2;
			this->tbYmax->Text = L"4";
			// 
			// tbXmax
			// 
			this->tbXmax->Location = System::Drawing::Point(1403, 136);
			this->tbXmax->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->tbXmax->Name = L"tbXmax";
			this->tbXmax->Size = System::Drawing::Size(49, 26);
			this->tbXmax->TabIndex = 3;
			this->tbXmax->Text = L"10";
			// 
			// tbYmin
			// 
			this->tbYmin->Location = System::Drawing::Point(1403, 101);
			this->tbYmin->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->tbYmin->Name = L"tbYmin";
			this->tbYmin->Size = System::Drawing::Size(50, 26);
			this->tbYmin->TabIndex = 4;
			this->tbYmin->Text = L"-4";
			// 
			// tbXmin
			// 
			this->tbXmin->Location = System::Drawing::Point(1403, 171);
			this->tbXmin->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->tbXmin->Name = L"tbXmin";
			this->tbXmin->Size = System::Drawing::Size(39, 26);
			this->tbXmin->TabIndex = 5;
			this->tbXmin->Text = L"-10";
			// 
			// pbPlot
			// 
			this->pbPlot->Location = System::Drawing::Point(14, 15);
			this->pbPlot->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->pbPlot->Name = L"pbPlot";
			this->pbPlot->Size = System::Drawing::Size(1330, 594);
			this->pbPlot->TabIndex = 6;
			this->pbPlot->TabStop = false;
			// 
			// btnUp
			// 
			this->btnUp->Location = System::Drawing::Point(1092, 634);
			this->btnUp->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnUp->Name = L"btnUp";
			this->btnUp->Size = System::Drawing::Size(84, 29);
			...
			// btnLeft
			// 
			this->btnLeft->Location = System::Drawing::Point(1009, 670);
			this->btnLeft->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnLeft->Name = L"btnLeft";
			this->btnLeft->Size = System::Drawing::Size(84, 29);
			...
			// btnDown
			// 
			this->btnDown->Location = System::Drawing::Point(1092, 706);
			this->btnDown->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnDown->Name = L"btnDown";
			this->btnDown->Size = System::Drawing::Size(84, 29);
			...
			// btnRight
			// 
			this->btnRight->Location = System::Drawing::Point(1176, 670);
			this->btnRight->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnRight->Name = L"btnRight";
			this->btnRight->Size = System::Drawing::Size(84, 29);
			...
			// btnIn
			// 
			this->btnIn->Location = System::Drawing::Point(618, 670);
			this->btnIn->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnIn->Name = L"btnIn";
			this->btnIn->Size = System::Drawing::Size(128, 29);
			...
			// btnOut
			// 
			this->btnOut->Location = System::Drawing::Point(618, 706);
			this->btnOut->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnOut->Name = L"btnOut";
			this->btnOut->Size = System::Drawing::Size(128, 29);
			...
			this->cbF->Items->AddRange(gcnew cli::array< System::Object^  >(5) { L"sinus", L"exppo", L"polynom", L"boom", L"cos" });
			this->cbF->Location = System::Drawing::Point(250, 669);
			this->cbF->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->cbF->Name = L"cbF";
			this->cbF->Size = System::Drawing::Size(136, 28);
			this->cbF->TabIndex = 13;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(753, 670);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(753, 706);
			this->button2->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(128, 29);
			...
			this->ClientSize = System::Drawing::Size(1372, 765);
...
#pragma endregion
		...
		void plot_net(Image^ img, Pen^ pn, Point origin) {
			Graphics^ gr = Graphics::FromImage(img);
			int Length_x = img->Width - origin.X;
			int Length_y = img->Height - origin.Y;
			for (int i = 0; i < Length_x; i += 50) {
	...
	private: System::Void btnBuild_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if(cbF->Text == "sinus")
			plot(sinus, xmin, xmax, ymin, ymax, pbPlot->Image);
		if(cbF->Text == "polynom")
			plot(polynom, xmin, xmax, ymin, ymax, pbPlot->Image);
		if(cbF->Text == "exppo")
			plot(exppo, xmin, xmax, ymin, ymax, pbPlot->Image);
		if(cbF->Text == "boom")
			plot(boom, xmin, xmax, ymin, ymax, pbPlot->Image);
		if(cbF->Text == "cos")
